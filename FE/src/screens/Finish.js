...
export default function Finish() {
  useEffect(() => {
    ...
    if (status === 'PAID') {
      ...
      alert("You are not allowed to download the file."); 
    }
  }, []);
  return (
    ...
    <h1 className="text-3xl">
      ...
      <div className="relative pt-16 w-full max-w-md mx-auto">
        <div className="relative p-4 text-center bg-blue-200 rounded-lg shadow sm:p-5">
          ...
          <a id="yourLinkID" style={{display:"none"}} href={ebook} download="Bí mật của may mắn.pdf"  className="py-2 px-3 text-sm font-medium text-center text-white rounded-lg bg-bluevio hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300" >
            Continue
          </a>
        </div>
      </div>
